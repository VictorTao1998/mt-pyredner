...
def sub_main(prefix_list):
    ...
    for idx in range(n):
        p = prefix_list[idx]
        if os.path.exists(os.path.join(args.data_folder, p, "normalL.png")) and args.skip:
...
def sub_main_rgb(prefix_list):
    ...
    for idx in range(n):
        p = prefix_list[idx]
        if os.path.exists(os.path.join(args.data_folder, p, "normal.png")) and args.skip:
            logger.info(f"Skip {p}")
            continue
