...
class PSMNetDilation(nn.Module):
    def __init__(
        ...
        self.feature_extraction = FeatureExtraction(num_ir + 1 if use_off else num_ir, base_channels=base_channels)

        self.dres0 = nn.Sequential(
            convbn_3d(base_channels*2, base_channels, 3, 1, 1),
            nn.ReLU(inplace=True),
        ...
        self.dres2 = hourglass(base_channels, dilation)
        self.dres3 = hourglass(base_channels, dilation)
        self.dres4 = hourglass(base_channels, dilation)
